...
package com.idemia.faulttolerance;
...
import static com.idemia.faulttolerance.FaultHandlingDocSample.CounterServiceApi.GetCurrentCount;
import static com.idemia.faulttolerance.FaultHandlingDocSample.WorkerApi.Do;
import static com.idemia.faulttolerance.FaultHandlingDocSample.WorkerApi.Start;
import static com.idemia.faulttolerance.FaultHandlingDocSample.WorkerApi.*;
import static com.idemia.faulttolerance.FaultHandlingDocSample.CounterServiceApi.*;
import static com.idemia.faulttolerance.FaultHandlingDocSample.CounterApi.*;
import static com.idemia.faulttolerance.FaultHandlingDocSample.StorageApi.*;
  ...
  public static class Worker extends AbstractLoggingActor {
    ...
    private static final SupervisorStrategy strategy =
        new OneForOneStrategy(
            DeciderBuilder.match(CounterServiceApi.ServiceUnavailable.class, e -> stop())
                .matchAny(o -> escalate())
                .build());
                  ...
                  x -> {
                    ...
                    pipe(
                            Patterns.ask(counterService, GetCurrentCount, askTimeout)
                                ...
                                .map(
                                    new Mapper<CounterServiceApi.CurrentCount, WorkerApi.Progress>() {
  ...
  public static class CounterService extends AbstractLoggingActor {
    ...
    private static final SupervisorStrategy strategy =
        new OneForOneStrategy(
            ...
            DeciderBuilder.match(StorageApi.StorageException.class, e -> restart())
                .matchAny(o -> escalate())
                .build());
    ...
    void initStorage() {
      ...
      if (counter != null) counter.tell(new CounterApi.UseStorage(storage), getSelf());
    ...
    public Receive createReceive() {
      return LoggingReceive.create(
          receiveBuilder()
              ...
              .match(
                  CounterServiceApi.Increment.class,
                  increment -> {
  ...
  public static class Storage extends AbstractLoggingActor {
    ...
    public Receive createReceive() {
      return LoggingReceive.create(
          receiveBuilder()
              .match(
                  StorageApi.Store.class,
                  store -> {
                    db.save(store.entry.key, store.entry.value);
                  })
              .match(
                  StorageApi.Get.class,
                  get -> {
                    Long value = db.load(get.key);
                    getSender()
                        .tell(
                            new StorageApi.Entry(get.key, value == null ? Long.valueOf(0L) : value),
                            getSelf());
                  })
              .build(),
          getContext());
